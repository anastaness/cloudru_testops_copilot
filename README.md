# Cloudru TestOps Copilot — Генератор API, manual и UI E2E тестов на базе Cloud.ru LLM

## О хакатоне

- **Название:** AI DevTools Hack
- **Организатор:** Changellenge >>
- **Даты:** 4–11 декабря 2025
- **Трек:** TestOps
- **Диплом участника:** [`changellenge2_testops_cloud.pdf`](docs/diploma/changellenge2_testops_cloud.pdf)
...
<p align="center">
  <img src="docs/images/main.jpg" alt="Интерфейс">
</p>
...
<div align="center">
  <img src="docs/images/validation.jpg" alt="Валидация" width="50%">
</div>

**Техническая валидация соединения: системный статус подтверждает устойчивую связь с Cloud.ru LLM**

<br>

<p align="center">
  <img src="docs/images/test.jpg" alt="Результат">
</p>
